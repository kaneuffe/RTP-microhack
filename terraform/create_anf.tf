...
output "anf_mountpoints" {
  value = zipmap([for value in data.azurerm_netapp_volume.anf_volume: value.mount_ip_addresses], [for value in data.azurerm_netapp_volume.anf_volume: value.name])
